...
// let input = prompt("Search object");
// let find_object = Products.find((elem) => elem.name == input);
...
// let discontinued_objects = Products.filter((elem) => elem.discontinued);
// console.log(discontinued_objects);

// #endregion

// #region TASK 4

// let get_unit_Price = Products.filter((elem) => elem.unitPrice > 22);
// console.log(get_unit_Price);

// #endregion

// #region TASK 5

// let from_spain = Products.filter(
//   (elem) => elem.supplier?.address.country == "Spain"
// );
// console.log(from_spain);
...
// let result = arr.every((elem) => elem.isDiscounted);
// console.log(result);

// let respond = arr.some((elem) => elem.isDiscounted);
// console.log(respond);
